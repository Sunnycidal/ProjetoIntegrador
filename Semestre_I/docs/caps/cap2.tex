...
solicitado individualmente antes de ser persistido no banco de dados da 
aplicação.
\clearpage
\begin{figure}[htbp]
    \centering
...
possibilitando a atualização individualizada de cada campo — nome, CPF, 
celular ou endereço — sem que seja necessário excluir e recriar o registro.