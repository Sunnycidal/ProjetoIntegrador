...
\begin{itemize}
    ...
    \item \textbf{Banco de Dados:} modelagem e armazenamento das informações como dados cadastrais dos clientes e dados dos pedidos;
    \item \textbf{UI/UX:} criação de interface com conceito intuitivo, organizado e simplificado a modo de facilitar a interação com o público-alvo;
    \item \textbf{Conceitos da Computação:} utilização de conceitos computacionais para análise inicial do projeto e definição de stack, arquitetura e requisitos.
\end{itemize}